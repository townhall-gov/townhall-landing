"use client"
// components/GovernanceComponent.tsx
...
const items = [
  {
    ...
    image: '/assets/solution4.svg', // replace with your image path
  },
  {
    ...
    image: '/assets/solution3.svg', // replace with your image path
  },
  {
    ...
    image: '/assets/solution2.svg', // replace with your image path
  },
  {
    ...
    image: '/assets/solution1.svg', // replace with your image path
  },
...
const Solution: React.FC = () => {
  return (
      <div className="grid relative py-12 grid-cols-3 bg-transparent">
      {/* Left Column */}
        ...
        {items.map((item, index) => (
          <div key={index} className="mb-8 flex justify-between w-full h-2/4 my-8 items-center">
            <div className="flex-1">
              <h2 className="text-xl text-destructive font-semibold mb-2">{item.title}</h2>
      ...
      <span className='absolute w-screen overflow-hidden border-b right-[-6rem] bottom-12'/>
    </div>
  );
};
