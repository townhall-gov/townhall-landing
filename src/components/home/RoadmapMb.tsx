...
const Card = ({
	...
	return (
		<>
			<div
				className={`w-full  px-4 pt-4 pb-1 flex items-end justify-between`}
			>
...
const RoadmapMb = () => {
	return (
		<section
			id="roadmap"
			className="flex sm:hidden w-full border-t-2 border-b-2  mt-24"
		>
			<div className=" flex-col relative justify-center items-center  border-l-2 ml-8 bg-transparent ">
				...
				<div className="flex-1 overflow-y-auto  ">
					<Card
						...
						quarter="Q1"
						points={[
							'Social Bounties Platform on Lens Protocol',
							'Townhall Governance Platform Launch and Onboarding'
						]}
					...
					<Card
						...
						points={[
							...
							'Community and Treasury Management Tools',
							'Launch of Collectibles'
						]}
