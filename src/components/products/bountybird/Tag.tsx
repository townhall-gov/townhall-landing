	...
	return (
		<section className='flex flex-col md:flex-row justify-between items-center w-full max-w-screen overflow-hidden p-8 pr-0 md:p-24 md:pr-0 '>
			<div className='flex flex-1 flex-col gap-8'>
				<h1 className='text-3xl md:text-6xl font-semibold'>Post , Share and Hunt Bounties</h1>
				<p className='text-lg poppins-light md:max-w-[600px]'>
					Create bounties on Twitter, Hey, and more with ease! Just tag <span className='text-destructive font-semibold'>@TheBountyBird</span> and use #create to post a bounty.
				</p>
