...
const Difference = () => {
	return (
		<section className="min-h-full relative w-full m-24 ">
			<div className="min-h-[120vh] flex relative flex-col justify-center items-center bg-gradient-to-r from-[#1c1e1f] via-[#305561] to-transparent blur-[25px] backdrop-blur-[23px] w-full h-full"></div>
			...
			<div className="absolute -bottom-12 md:bottom-12  left-1/2 transform -translate-x-1/2 flex flex-col md:flex-row items-center md:items-top w-full justify-evenly gap-4 md:gap-8">
				<Card
				...
				<Card
					...
					text="Easy Onboarding: Login via Privy or Safe"
