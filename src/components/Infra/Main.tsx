...
const Main = () => {
  return (
    <section className='grid grid-cols-12 h-full justify-between items-center overflow-hidden w-full pl-24'>
        <div className="col-span-7 inline-flex flex-col items-start relative">
            <h1 className='text-5xl font-semibold leading-6'>Governance that fits “You”</h1>
